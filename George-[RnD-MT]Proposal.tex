...
\begin{itemize}
    ...
    \item Radiation source is said to be really dangerous for human health, and therefore, 
    it is important to detect the radiation source and take necessary actions to avoid the exposure. 
    \item The project aims to develop a system that can detect the radiation source and provide the necessary information to the user.
    \item 
\end{itemize}
